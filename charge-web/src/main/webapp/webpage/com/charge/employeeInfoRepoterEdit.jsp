...
<html>
 ...
 <body>
   <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="employeeInfoController.do?change" tiptype="1"  beforeSubmit="otherCheck()">
		   ...
		   <div style="border:1px solid #ababab;padding:5px;border-radius: 5px;margin-top:30px;padding-bottom: 20px;">
		        ...
		        <div style="margin-top: -25px;">
					...
					<div style="margin-right:25px;float:left;height:35px">
				         ...
				         <input class="inputxt" id="code" name="code" autocomplete="off"  value="${employeeInfoPage.code}" onchange="codeCheck()" disabled="disabled" maxlength="49" />
						 <span class="Validform_checktip"></span>
					</div>
					 <div style="margin-right:25px;float:left;height:35px">
					  ...
					  <input class="inputxt" id="cmbAccount" name="cmbAccount" autocomplete="off" value="${employeeInfoPage.cmbAccount}" maxlength="49"
				...
				<div style="margin-right:25px;float:left;height:35px">
	 				 ...
	 				 <input class="inputxt" id="icbcAccount" name="icbcAccount" autocomplete="off" value="${employeeInfoPage.icbcAccount}" maxlength="49"
		        ...
		        <div>
		        	<div style="margin-right:25px;float:left;height:35px">
				          ...
				          <input class="inputxt" id="contactWay" name="contactWay" autocomplete="off" datatype="m" ignore="ignore" value="${employeeInfoPage.contactWay}" maxlength="99"  />
		            	  <span class="Validform_checktip"></span>
					</div>
					<div style="margin-right:25px;float:left;height:35px">
						<label class="Validform_label">邮箱:</label>
						<input class="inputxt" id="email" name="email" autocomplete="off" datatype="e" value="${employeeInfoPage.email}" ignore="ignore" maxlength="99" />
						<span class="Validform_checktip"></span>
					</div>
				   <div style="margin-right:25px;float:left;height:35px">
			   ...
			   <div style="clear:both"></div>
		        ...
		        <div>
		        	...
		        	<div style="margin-right:25px;float:left;height:35px">
				          ...
				          <input class="inputxt" id="unitPrice" name="unitPrice"  autocomplete="off" maxlength="9" autocomplete="off" ignore="ignore"
		   ...
		   <div style="border:1px solid #ababab;padding:5px;border-radius: 5px;margin-top:30px;padding-bottom: 20px;">
		        ...
		        <div style="margin-top: -25px;">
					<div style="margin-right:25px;float:left;height:35px">
		                 ...
		                 <input class="inputxt" id="aStandardSalary" autocomplete="off" name="aStandardSalary" onchange="performanceChange()" maxlength="9" value="${employeeInfoPage.AStandardSalary}"
		                data-options="precision:2,groupSeparator:','" disabled="disabled"/>
		                 <span class="Validform_checktip"></span>
					</div>
					<div style="margin-right:25px;float:left;height:35px">
					...
					<div style="margin-right:25px;float:left;height:35px">
		            	  ...
		            	  <input class="inputxt" id="discount" name="discount" autocomplete="off" maxlength="9"
		        ...
		        <div>
			        ...
			        <div style="margin-top: -20px;">
						<div style="margin-right:25px;float:left;height:35px">
						      ...
						      <input class="inputxt" id="sixGoldCity" name="sixGoldCity" disabled="disabled" value="${employeeInfoPage.sixGoldCity}"></input>
			      	          <span class="Validform_checktip"></span>
						</div>
						<div style="margin-right:25px;float:left;height:35px">
					          ...
					          <%-- <input class="inputxt" id="sixGoldBase" name="sixGoldBase" value="${employeeInfoPage.sixGoldBase}" datatype="/(^\s*$)|(^(-)?[1-9]([0-9]+)?(\.[0-9]{1,2})?$)|(^(0){1}$)|(^[0-9]\.[0-9]([0-9])?$)/" /> --%>
			      		      <input class="inputxt" id="sixGoldBase" autocomplete="off" name="sixGoldBase"  maxlength="9" data-options="precision:2,groupSeparator:','"
			      		      value="${employeeInfoPage.sixGoldBase}" disabled="disabled"/>
		        ...
		        <div>
		            <div style="margin-right:25px;float:left;height:35px">
				          ...
				          <input class="inputxt" id="a1Place" name="a1Place" value="${employeeInfoPage.a1Place}" disabled="disabled"></input>
		      	          <span class="Validform_checktip"></span>
					</div>
		        	<div style="margin-right:25px;float:left;height:35px">
		            	  ...
		            	  <input class="inputxt" id="a1Payment" name="a1Payment" autocomplete="off" disabled="disabled" maxlength="9" data-options="precision:2,groupSeparator:','"
		            	  value="${employeeInfoPage.a1Payment}"/>
		            	  <span class="Validform_checktip"></span>
					</div>
		        </div>
			    <div style = "clear:both"></div>
  ...
  //设置当员工为本部时，部门经理下拉框默认为部门总监且变灰
   ...
   function otherCheck(){
	   ...
	   if($("select[name='employeeFlag']").val() == 1){
		   $('#unitPrice').val("");
	   }
   ...
   function inputerName(){
	   $.ajax({
		   url: "employeeInfoController.do?getInputerName",
		   type: "get",
		   success: function(data){
			   data = JSON.parse(data);
			   ...
			   if(data.length == 0){
				   nameOpt+= "<option value='' selected='selected'>--- 无 ---</option>";
			   }
