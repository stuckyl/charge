...
function declareSubmit(){
	   ...
	   var index =  $('#projectList').datagrid('getRows');
		...
		if(isErr) {
			layer.alert('编号：'+tip1+'的项目当前状态不可通过');
			return false;
		}
		//if(!(id=="")){
...
function returnSubmit(){
	   ...
	   var index =  $('#projectList').datagrid('getRows');
		...
		if(isErr3) {
			layer.alert('编号：'+tip2+'的项目当前状态不可拒绝');
			return false;
		}
...
function excelExport(){
 ...
 <!--  onDblClick="update('查看','employeeDeclareController.do?lookorcheck','employeeDeclareList','100%','100%')" -->
   ...
   <t:dgCol title="申报状态" field="projectStatus"   width="120" query="true" replace="审批通过_1,待处理_${actionCode},未上报_${actionCode+1}," extendParams="resizable:false,styler: function(value,row,index){if(value=='${actionCode}'){return 'color:red;';}}" align="center"></t:dgCol>
