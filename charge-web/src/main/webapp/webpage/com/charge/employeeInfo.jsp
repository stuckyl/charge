...
<html>
 ...
 <body>
   <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="employeeInfoController.do?save" tiptype="1" beforeSubmit="otherCheck()">
		   ...
		   <div style="border:1px solid #ababab;padding:5px;border-radius: 5px;margin-top:30px;padding-bottom: 20px;">
		        ...
		        <div style="margin-top: -25px;">
					...
					<div style="margin-right:25px;float:left;height:35px">
				         ...
				         <input class="inputxt" id="code" name="code" autocomplete="off" value="${employeeInfoPage.code}" onchange="codeChake()" maxlength="49" />
						 <span class="Validform_checktip"></span>
					</div>
		   ...
		   <div style="border:1px solid #ababab;padding:5px;border-radius: 5px;margin-top:30px;padding-bottom: 20px;">
		        ...
		        <div style="margin-top: -25px;">
					<div style="margin-right:25px;float:left;height:35px">
		                 ...
		                 <input class="inputxt" id="aStandardSalary" name="aStandardSalary" onchange="performanceChange()" maxlength="9" value="${employeeInfoPage.AStandardSalary}"
					...
					<div style="margin-right:25px;float:left;height:35px">
				          ...
				          <input class="inputxt" id="basePay" name="basePay" disabled="disabled" maxlength="9" autocomplete="off" value="${basePay}" data-options="precision:2,groupSeparator:','" />
		            	  <span class="Validform_checktip"></span>
					</div>
					<div style="margin-right:25px;float:left;height:35px">
					...
					<div style="margin-right:25px;float:left;height:35px">
		            	  ...
		            	  <!-- datatype="/(^[1-9][0-9](\.[0-9]{1,2})?$)|(^[0](\.[1-9]{1}([0]{1})?)$)|(^[0](\.[0-9]{1}[1-9]{1})$)|(^[1-9](\.[0-9]{1,2})?$)|^100(\.(([0]{1})?([0]{1})?))?$/"  /> -->
						  <span class="Validform_checktip"></span>
					</div>
		        </div>
		        <div style = "clear:both"></div>
		        ...
		        <div>
		        	...
		        	<div style="margin-right:25px;float:left;height:35px">
		            	  ...
		            	  <input class="inputxt" id="a1Payment" name="a1Payment" autocomplete="off" onchange="a1pChange()" maxlength="9" data-options="precision:2,groupSeparator:','"
		   ...
		   <div style="border:1px solid #ababab;padding:5px;border-radius: 5px;margin-top:30px;padding-bottom: 20px;">
		        ...
		        <div>
		            <div style="margin-right:25px;float:left;height:35px">
				          ...
				          <t:dictSelect field="a1PlaceCh" typeGroupCode="payArea"  defaultVal="${(employeeInfoPage.a1PlaceCh == null||employeeInfoPage.a1PlaceCh == '')?employeeInfoPage.a1Place:employeeInfoPage.a1PlaceCh}" extendJson="{onchange='a1pChangeCh()',style='width: 157px;'}"></t:dictSelect>
		      	          <span class="Validform_checktip"></span>
					</div>
		        	<div style="margin-right:25px;float:left;height:35px">
		...
		<input id="ASalsry" name="ASalsry" type="hidden" value="${employeeInfoPage.AStandardSalary}">
   ...
   function otherCheck(){
	  ...
	  if(!rs){
	   ...
	   if($("#a2Place").val()=="江苏"&&$("select[name='a1Place']").val()=="江苏"){
   		...
   		layer.msg('薪酬安排，发薪金额1小于A(标准)，此时发薪地1不可选择为江苏！');
		   return false;
   	}
	   var sexgod = handleNum($("#sixGoldBase").val());
