...
<html>
		   ...
		   <div style="border:1px solid #ababab;padding:5px;border-radius: 5px;margin-top:30px;padding-bottom: 20px;">
		        ...
		        <div style="margin-top: -15px;">
					...
					<div style="margin-right:25px;float:left;height:35px">
					  ...
					  onchange="forMoney()" maxlength="11" autocomplete="off" data-options="precision:2,groupSeparator:','"
					   datatype="*"/>
					  <span class="Validform_checktip"></span>
					</div>
					<div style="margin-right:25px;float:left;height:35px">
 ...
 function gradeChange(){
	 ...
	 if(c1Other==0){
		 ...
		 $("#c1OtherSupplier").prop("disabled", true);
		 $("#c1OtherMoney").prop("disabled",false);
		 $("#c1OtherRemarks").prop("disabled",false);
	 }else if(c1Other==1){
		 $("#c1OtherSupplier").prop("disabled", false);
		 $("#c1OtherMoney").prop("disabled",false);
		 $("#c1OtherRemarks").val("");
		 $("#c1OtherRemarks").prop("disabled",true);
	 }else{
		 $("#c1OtherSupplier").val("-1")
		 $("#c1OtherSupplier").prop("disabled", true);
		 $("#c1OtherMoney").val("");
		 $("#c1OtherMoney").prop("disabled",true);
		 $("#c1OtherRemarks").val("");
		 $("#c1OtherRemarks").prop("disabled",true);
	 }
	 ...
	 if(c2Other==0){
		 ...
		 $("#c2OtherSupplier").prop("disabled", true);
		 $("#c2OtherMoney").prop("disabled",false);
		 $("#c2OtherRemarks").prop("disabled",false);
	 }else if(c2Other==1){
		 $("#c2OtherSupplier").prop("disabled", false);
		 $("#c2OtherMoney").prop("disabled",false);
		 $("#c2OtherRemarks").val("");
		 $("#c2OtherRemarks").prop("disabled",true);
	 }else{
		 $("#c2OtherSupplier").val("-1")
		 $("#c2OtherSupplier").prop("disabled", true);
		 $("#c2OtherMoney").val("");
		 $("#c2OtherMoney").prop("disabled",true);
		 $("#c2OtherRemarks").val("");
		 $("#c2OtherRemarks").prop("disabled",true);
	 }
	 ...
	 if(c3Other==0){
		 ...
		 $("#c3OtherSupplier").prop("disabled", true);
		 $("#c3OtherMoney").prop("disabled",false);
		 $("#c3OtherRemarks").prop("disabled",false);
	 }else if(c3Other==1){
		 $("#c3OtherSupplier").prop("disabled", false);
		 $("#c3OtherMoney").prop("disabled",false);
		 $("#c3OtherRemarks").val("");
		 $("#c3OtherRemarks").prop("disabled",true);
	 }else{
		 $("#c3OtherSupplier").val("-1")
		 $("#c3OtherSupplier").prop("disabled", true);
		 $("#c3OtherMoney").val("");
		 $("#c3OtherMoney").prop("disabled",true);
		 $("#c3OtherRemarks").val("");
		 $("#c3OtherRemarks").prop("disabled",true);
	 }
	 ...
	 if(c4Other==0){
		 ...
		 $("#c4OtherSupplier").prop("disabled", true);
		 $("#c4OtherMoney").prop("disabled",false);
		 $("#c4OtherRemarks").prop("disabled",false);
	 }else if(c4Other==1){
		 $("#c4OtherSupplier").prop("disabled", false);
		 $("#c4OtherMoney").prop("disabled",false);
		 $("#c4OtherRemarks").val("");
		 $("#c4OtherRemarks").prop("disabled",true);
	 }else{
		 $("#c4OtherSupplier").val("-1")
		 $("#c4OtherSupplier").prop("disabled", true);
		 $("#c4OtherMoney").val("");
		 $("#c4OtherMoney").prop("disabled",true);
		 $("#c4OtherRemarks").val("");
		 $("#c4OtherRemarks").prop("disabled",true);
	 }
	 ...
	 if(c5Other==0){
		 ...
		 $("#c5OtherSupplier").prop("disabled", true);
		 $("#c5OtherMoney").prop("disabled",false);
		 $("#c5OtherRemarks").prop("disabled",false);
	 }else if(c5Other==1){
		 $("#c5OtherSupplier").prop("disabled", false);
		 $("#c5OtherMoney").prop("disabled",false);
		 $("#c5OtherRemarks").val("");
		 $("#c5OtherRemarks").prop("disabled",true);
	 }else{
		 $("#c5OtherSupplier").val("-1")
		 $("#c5OtherSupplier").prop("disabled", true);
		 $("#c5OtherMoney").val("");
		 $("#c5OtherMoney").prop("disabled",true);
		 $("#c5OtherRemarks").val("");
		 $("#c5OtherRemarks").prop("disabled",true);
	 }
	 forMoney();
