 ...
 <body>
   <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="employeeInfoController.do?change" tiptype="1" beforeSubmit="otherCheck()">
		   ...
		   <div style="border:1px solid #ababab;padding:5px;border-radius: 5px;margin-top:30px;padding-bottom: 20px;">
		        ...
		        <div style="margin-top: -25px;">
					...
					<div style="margin-right:25px;float:left;height:35px">
				         ...
				         <input class="inputxt" id="code" name="code" autocomplete="off" value="${employeeInfoPage.code}" onchange="codeChake()" disabled="disabled" maxlength="49" />
						 <span class="Validform_checktip"></span>
					</div>
		   ...
		   <div style="border:1px solid #ababab;padding:5px;border-radius: 5px;margin-top:30px;padding-bottom: 20px;">
		        ...
		        <div style="margin-top: -25px;">
					<div style="margin-right:25px;float:left;height:35px">
		                 ...
		                 <input class="inputxt" id="aStandardSalary" name="aStandardSalary" disabled="disabled" maxlength="9" value="${employeeInfoPage.AStandardSalary}"
					...
					<div style="margin-right:25px;float:left;height:35px">
				          ...
				          <input class="inputxt" id="basePay" name="basePay" disabled="disabled" maxlength="9" autocomplete="off" disabled="disabled" value="${employeeInfoPage.basePay}" data-options="precision:2,groupSeparator:','" />
		            	  <span class="Validform_checktip"></span>
					</div>
					<div style="margin-right:25px;float:left;height:35px">
					      <label class="Validform_label"><span style="color:red">*</span>绩效工资:</label>
		            	  <input class="inputxt" id="meritPay" name="meritPay"  maxlength="9" disabled="disabled" disabled="disabled" data-options="precision:2,groupSeparator:','"
			        ...
			        <div style="margin-top: -20px;">
						...
						<div style="margin-right:25px;float:left;height:35px">
					          ...
					          <%-- <input class="inputxt" id="sixGoldBase" name="sixGoldBase" value="${employeeInfoPage.sixGoldBase}" datatype="/(^\s*$)|(^(-)?[1-9]([0-9]+)?(\.[0-9]{1,2})?$)|(^(0){1}$)|(^[0-9]\.[0-9]([0-9])?$)/" /> --%>
			      		      <input class="inputxt" id="sixGoldBase" name="sixGoldBase" maxlength="9" disabled="disabled" data-options="precision:2,groupSeparator:','"
			      		      value="${employeeInfoPage.sixGoldBase}" autocomplete="off"
			      		      datatype="*" />
			      		      <span class="Validform_checktip"></span>
						</div>
			        </div>
		        ...
		        <div>
		        	...
		        	<div style="margin-right:25px;float:left;height:35px">
		            	  ...
		            	  <input class="inputxt" id="a1Payment" name="a1Payment" autocomplete="off" maxlength="9" disabled="disabled" data-options="precision:2,groupSeparator:','"
		            	  value="${employeeInfoPage.a1Payment}" datatype="*"/>
		            	  <span class="Validform_checktip"></span>
					</div>
		        </div>
			    <div style = "clear:both"></div>
		...
		<c:if test="${rolecode==2}">
		 <input id="employeeFlag" name="employeeFlag" type="hidden" value=1>
		 </c:if>
		<input id="id" name="id" type="hidden" value="${employeeInfoPage.id }">
		<input id="declareStatus" name="declareStatus" type="hidden" value=1>
		<input name="a1ConfirmSalary" value="3500"  hidden="true"/>
  ...
  function inputerIdSUM(){
   ...
   function fieldReadOnly(){
	   ...
	   if(""!=$.trim($("#quitReason").val())){
		   $("#quitReason").attr("disabled","disabled");
	   } */
   }
   var customers={};
   $(document).ready(function(){
	   cityGroup();
	   var Flag = "${employeeInfoPage.employeeFlag}";
		 if(1==Flag){
		   $("#customerId").attr("ignore", "ignore");
			$("#unitPriceType").attr("ignore", "ignore");
			$("#unitPrice").attr("ignore", "ignore");
