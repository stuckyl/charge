...
<!-- <div id="divUserList" class="easyui-layout" style="width:100%;">
	...
	<t:datagrid name="departUserList" title="common.operation"
		...
		<t:dgToolBar title="common.add.param" width="100%" height="100%" langArg="common.user" icon="icon-add" url="userController.do?addorupdateMyOrgUser&departid=${departid}" funname="add"></t:dgToolBar>
		<t:dgToolBar title="common.edit.param" width="100%" height="100%"  langArg="common.user" icon="icon-edit" url="userController.do?addorupdateMyOrgUser&departid=${departid}" funname="update"></t:dgToolBar>
