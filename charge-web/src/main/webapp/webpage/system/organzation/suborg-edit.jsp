...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" callback="@Override callbackOrg" action="systemController.do?editDepart" >
...
<%-- 				<tr>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="departname" name="departname" value="${depart.departname }" validType="t_s_depart,departname,id" type="text" style="width: 150px" class="inputxt"  datatype="*2-18"/>
