	...
	<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			...
			<td class="value" width="85%">
                ...
                <c:if test="${user.id==null }">
                    <input id="userName" class="inputxt"  autocomplete="off" name="userName" validType="t_s_base_user,userName,id" value="${user.userName }" datatype="/(^[0-9a-zA-Z-]{2,18}$)/" />
		...
		<tr>
			...
			<td class="value" width="10%">
                <input id="realName" class="inputxt" autocomplete="off" name="realName" value="${user.realName }" datatype="*2-18"/>
...
<%--         <tr>
		...
		<tr>
			...
			<td class="value" width="85%">
                    <input id="password" class="inputxt" name="password" value="" datatype="/(^[0-9a-zA-Z-]{6,18}$)/" autocomplete="off"/>
                    <!-- <input id="departEntryPwd" name="departEntryPwd" type="text" style="width: 150px" class="inputxt"  datatype="*6-18" /> -->
                   <span class="Validform_checktip"> <t:mutiLang langKey="请输入6到18位大、小写字母或数字"/></span>            </td>
		</tr>
		</c:if>
		<%-- <c:if test="${user.id==null }">
			<tr>
