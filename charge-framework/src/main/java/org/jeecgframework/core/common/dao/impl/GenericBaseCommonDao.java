...
//		}
		...
		// 返回的是  List<EmployeeDeclareEntiey> list集合
		// 将 EmployeeDeclareEntity 数据 赋值到 dataGrid 属性中的 ArrayList<E> results去。供 前台页面读取
		cq.getDataGrid().setResults(list);
		// 因为 设置了 分页 ，传入 数据总条数 到 dataGrid.total 属性中去
