...
//		}
	...
	public StringBuffer end() {
		...
		sb.append("pageList:["+20 + "," + 50 + "," + 100 + ","+ 200+","+9999+"],");
		...
		if("group".equals(getQueryMode())){
			for (DataGridColumn col : columnList) {
				if (col.isQuery()) {
					...
					sb.append("<span style=\"vertical-align:middle;display:-moz-inline-box;display:inline-block;width: 110px;text-align:right;text-overflow:ellipsis;-o-text-overflow:ellipsis; overflow: hidden;white-space:nowrap;margin-right: 5px; \" title=\""+col.getTitle()+"\">"+col.getTitle()+"</span>");
					if("single".equals(col.getQueryMode())){
						if(!StringUtil.isEmpty(col.getReplace())){
							...
							sb.append("<input onkeypress=\"EnterPress(event)\" onkeydown=\"EnterPress()\" autocomplete=\"off\" type=\"text\" name=\""+col.getField().replaceAll("_","\\.")+"\"  "+extendAttribute(col.getExtend())+" ");
