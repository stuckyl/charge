...
public class EmployeeGridTag extends JeecgTag {
	private Logger log = Logger.getLogger(EmployeeGridTag.class);
...
//        log.info("================================ EmployeeGridTag 开始时间:"+sdf.format(new Date())+"==============================");
		JspWriter out = null;
		try {
...
//         log.info("=============================== EmployeeGridTag 结束时间:"+sdf.format(new Date())+"==============================");
//         log.info("================================ EmployeeGridTag 耗时:"+(end-start)+"ms==============================");
		return EVAL_PAGE;
	}
...
//		}
	...
	public String toString(){
		...
		key.append("EmployeeGridTag [fields=").append(fields)
	...
	public StringBuffer end() {
		...
		if(hasQueryColum(columnList) && "group".equals(getQueryMode())){
			...
			sb.append("<span style=\"max-width: 84%;display: inline-block;\">");
	 ...
	 * @frozen 0 冰冻列    1 普通列
	 */
	protected void getFixField(StringBuffer sb) {
		sb.append("{title:\'9\',colspan:3,align:\'center\'},");
		sb.append("{title:\' \',colspan:2,align:\'center\'},");
		sb.append("{title:\'17838\',align:\'center\'},");
		sb.append("{title:\'1000\',align:\'center\'},");
		sb.append("{title:\'132\',align:\'center\'},");
		sb.append("{title:\'21.9\',align:\'center\'},");
		sb.append("{title:\' \',colspan:3,align:\'center\'},");
		sb.append("{title:\'0\',align:\'center\'},");
		sb.append("{title:\'188232\',align:\'center\'},");
		sb.append("{title:\'0%\',align:\'center\'},");
		sb.append("{title:\' \',align:\'center\'},");
		sb.append("{title:\'0.0%\',colspan:2,align:\'center\'},");
		sb.append("{title:\' \',align:\'center\'},");
		sb.append("{title:\' \',align:\'center\'},");
		sb.append("{title:\'113801\',align:\'center\'},");
		sb.append("{title:\'97.8%\',align:\'center\'},");
		sb.append("{title:\'69.8%\',colspan:2,align:\'center\'},");
		sb.append("{title:\'0\',align:\'center\'},");
		sb.append("{title:\'0\',align:\'center\'},");
		sb.append("{title:\'-2500\',align:\'center\'},");
		sb.append("{title:\'-2500\',align:\'center\'},");
		sb.append("{title:\'109741\',align:\'center\'},");
		sb.append("{title:\'9\',align:\'center\'}");
	}
		...
		if("group".equals(getQueryMode())){
			for (DataGridColumn col : columnList) {
				if (col.isQuery()) {
					...
					sb.append("<span style=\"vertical-align:middle;display:-moz-inline-box;display:inline-block;width: 110px;text-align:right;text-overflow:ellipsis;-o-text-overflow:ellipsis; overflow: hidden;white-space:nowrap; \" title=\""+col.getTitle()+"\">"+col.getTitle()+"：</span>");
